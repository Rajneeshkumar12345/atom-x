...
const services = () => {
  return (
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
        <div className="photo" style={{textAlign:"centre", width:"auto", minWidth:"42rem",margin:"auto"}}>
        <img src="/our_services.jpg" height="550px" width="auto" style={{objectFit:"cover" }} padding="50px" class="card-img-top" alt="image"/>
        </div>
